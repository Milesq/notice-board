...
const messages = {
  ...
  Ru: {
    ...
    nameErrors: ['Имя и фамилия должны состоять только из букв ', 'Имя И Фамилия'],
    name: 'Имя',
    search: 'Поиск...',
    deletePrompt: 'Удалить пользователя {name}',
    incorrectData: 'Неправильные данные',
    logout: 'Выйти',
    changeTheme: 'Изменить фон',
    addUsers: 'Добавить пользователя',
    manageAnnouncements: 'Менеджер объявлений',
    titleWord: 'Тема',
    settings: 'Настройки',
    save: 'Сохранить',
    saved: 'Сохранено',
    ...
    tooShort: 'Слишком короткий текст. Минимальное количество букв  {minVal}',
    noData: 'Данные отсутствуют',
    areYouWantCancel: 'Закрыть вкладку? Изменения не будут сохранены',
    created_at: 'Дата создания',
    updated_at: 'Дата изменения',
    notificationAsk: 'Хочешь получать уведомление о новых объявлениях?',
    notificationAllow: 'Конечно!',
    notificationDeny: 'Нет, спасибо. Возможно, позже',
  },
};
